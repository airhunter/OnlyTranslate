...
export const options = {
    ...
    keys: [
        ...
        {value: "Computer", label: "键盘", labelKey: "option.hotkeys.keyboard", disabled: true},
        {value: "Control", label: "Ctrl"},
        {value: "Alt", label: "Alt"},
        {value: "Shift", label: "Shift"},
        {value: "Escape", label: "ESC"},
        {value: "`", label: "`"},
        {value: "mouse", label: "鼠标", labelKey: "option.hotkeys.mouse", disabled: true},
        {value: "DoubleClick", label: "双击", labelKey: "option.hotkeys.doubleClick"},
        {value: "LongPress", label: "长按", labelKey: "option.hotkeys.longPress"},
        {value: "MiddleClick", label: "中键", labelKey: "option.hotkeys.middleClick"},
        {value: "touchscreen", label: "触屏", labelKey: "option.hotkeys.touchscreen", disabled: true},
        {value: "TwoFinger", label: "双指", labelKey: "option.hotkeys.twoFinger"},
        {value: "ThreeFinger", label: "三指", labelKey: "option.hotkeys.threeFinger"},
        {value: "FourFinger", label: "四指", labelKey: "option.hotkeys.fourFinger"},
        {value: "DoubleClickScree", label: "双击屏幕", labelKey: "option.hotkeys.doubleClickScreen"},
        {value: "TripleClickScree", label: "三击屏幕", labelKey: "option.hotkeys.tripleClickScreen"},
    ...
    display: [
        ...
        {value: 1, label: "双语对照", labelKey: "option.display.bilingual"},
    ],
    styles: [
        {value: "basic", label: "基础", labelKey: "option.styles.basic", disabled: true},
        {value: 0, label: "默认", labelKey: "option.styles.default", class: "fluent-display-default", group: "basic"},
        {value: 1, label: "粗体", labelKey: "option.styles.bold", class: "fluent-display-bold", group: "basic"},
        {value: 2, label: "斜体", labelKey: "option.styles.italic", class: "fluent-display-italic", group: "basic"},
        {value: 3, label: "阴影", labelKey: "option.styles.shadow", class: "fluent-display-text-shadow", group: "basic"},
        {value: "underline", label: "下划线", labelKey: "option.styles.underline", disabled: true},
        {value: 4, label: "实线下划线", labelKey: "option.styles.solidUnderline", class: "fluent-display-solid-underline", group: "underline"},
        {value: 5, label: "点状下划线", labelKey: "option.styles.dotUnderline", class: "fluent-display-dot-underline", group: "underline"},
        {value: 6, label: "波浪线", labelKey: "option.styles.wavy", class: "fluent-display-wavy", group: "underline"},
        {value: "card", label: "卡片", labelKey: "option.styles.card", disabled: true},
        {value: 7, label: "卡片模式", labelKey: "option.styles.cardMode", class: "fluent-display-card-mode", group: "card"},
        {value: 8, label: "现代卡片", labelKey: "option.styles.modernCard", class: "fluent-display-modern-card", group: "card"},
        {value: 9, label: "纸张样式", labelKey: "option.styles.paper", class: "fluent-display-paper", group: "card"},
        {value: "highlight", label: "高亮", labelKey: "option.styles.highlight", disabled: true},
        {value: 10, label: "学习模式", labelKey: "option.styles.learning", class: "fluent-display-learning-mode", group: "highlight"},
        {value: 11, label: "马克笔", labelKey: "option.styles.marker", class: "fluent-display-marker", group: "highlight"},
        {value: 12, label: "渐隐高亮", labelKey: "option.styles.highlightFade", class: "fluent-display-highlight-fade", group: "highlight"},
        {value: "background", label: "背景", labelKey: "option.styles.background", disabled: true},
        {value: 13, label: "浅黄色", labelKey: "option.styles.lightYellow", class: "fluent-display-lightyellow", group: "background"},
        {value: 14, label: "浅蓝色", labelKey: "option.styles.lightBlue", class: "fluent-display-lightblue", group: "background"},
        {value: 15, label: "浅灰色", labelKey: "option.styles.lightGray", class: "fluent-display-lightgray", group: "background"},
        {value: "special", label: "特殊", labelKey: "option.styles.special", disabled: true},
        {value: 16, label: "引用", labelKey: "option.styles.quote", class: "fluent-display-quote", group: "special"},
        {value: 17, label: "边框", labelKey: "option.styles.border", class: "fluent-display-border", group: "special"},
        {value: 18, label: "聚焦", labelKey: "option.styles.focus", class: "fluent-display-focus", group: "special"},
        {value: 19, label: "清爽", labelKey: "option.styles.clean", class: "fluent-display-clean", group: "special"},
        {value: "pro", label: "进阶", labelKey: "option.styles.pro", disabled: true},
        {value: 20, label: "科技", labelKey: "option.styles.tech", class: "fluent-display-tech", group: "pro"},
        {value: 21, label: "优雅", labelKey: "option.styles.elegant", class: "fluent-display-elegant", group: "pro"},
        {value: "transparent", label: "透明", labelKey: "option.styles.transparent", disabled: true},
        {value: 22, label: "柔和", labelKey: "option.styles.dimmed", class: "fluent-display-dimmed", group: "transparent"},
        {value: 23, label: "透明模式", labelKey: "option.styles.transparentMode", class: "fluent-display-transparent-mode", group: "transparent"},
    ],
    floatingBallHotkeys: [
        {value: "none", label: "无", labelKey: "option.hotkeys.none"},
    ...
    theme: [
        {value: "auto", label: "跟随系统", labelKey: "option.theme.auto"},
        {value: "light", label: "浅色", labelKey: "option.theme.light"},
        {value: "dark", label: "深色", labelKey: "option.theme.dark"},
    ],
    uiLocale: [
