...
只译是一款专注阅读体验的浏览器翻译扩展。它可以翻译网页正文、整页内容、划词、悬停文本、输入框和视频字幕，并尽量保留原页面的结构与阅读节奏。
...
<p align="center">
  <img src="./public/help/popup-overview.png" alt="只译扩展弹窗" width="360">
</p>
...
弹窗底部的「帮助」提供可搜索的完整操作说明，包括翻译模式、划词与悬停、输入框、视频字幕、服务配置和常见问题。帮助内容保存在扩展内，可以离线阅读。
...
- 翻译结果和视频字幕可能缓存在本地，以减少重复请求；可以随时通过弹窗底部的「清除缓存」删除。
...
OnlyTranslate 基于 [FluentRead（流畅阅读）](https://github.com/Bistutu/FluentRead) 开发。在保留核心网页翻译能力的基础上，重点补充了视频字幕翻译、识文 / 全页切换和更精简的设置体验。感谢原作者及所有贡献者的开源工作。
